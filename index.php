...
<body class="font-poppins">
  ...
  <!-- Navbar -->
  <nav class="hidden lg:flex max-w-7xl w-full items-center justify-between mx-auto py-4">
    <a href="index.php"><img src="./images/logo/logo.webp" alt="logo" class="w-36"></a>
    <div class="flex gap-2">
      <a href="home.php" class="py-2 px-4 hover:bg-gray-200 rounded-full">Restaurants</a>
      <a href="new_track_order.php" class="py-2 px-4 hover:bg-gray-200 rounded-full">Orders</a>
      <a href="about.php" class="py-2 px-4 bg-gray-900 text-white rounded-full font-semibold">About</a>
    </div>
    <div>
      <?php if ($login_status) {
        echo '<a href="user_logout.php" class="bg-red-500 text-white px-6 py-2 rounded-full">Logout</a>';
      } else {
        echo '<a href="user_login.php" class="bg-gray-900 text-white px-6 py-2 rounded-full">Login</a>';
      } ?>
    </div>
  </nav>

  <!-- Hero Section -->
  <div class="hero-section bg-cover bg-center h-[300px] flex items-center justify-center" 
       style="background-image: url('images/about/about-banner.webp');">
    <div class="bg-black bg-opacity-50 w-full h-full flex justify-center items-center">
      <h1 class="text-4xl md:text-5xl text-white font-bold">About Alimento</h1>
    </div>
  </div>

  <!-- About Content -->
  <section class="max-w-5xl mx-auto py-10 px-5 text-center">
    <h2 class="text-3xl font-bold mb-5">Who We Are</h2>
    <p class="text-gray-700 text-lg leading-relaxed">
      At <span class="font-semibold">Alimento</span>, we deliver <b>home-made meals</b> made with love. 
      Our goal is to bring healthy, affordable, and sustainable food options straight to your doorstep.
    </p>
  </section>

  <!-- Eco-Friendly Packaging Highlight -->
  <section class="max-w-5xl mx-auto py-10 px-5 grid md:grid-cols-2 gap-10 items-center">
    <div class="p-6">
      <h3 class="text-2xl font-bold mb-3 text-green-700">🌱 Eco-Friendly Packaging</h3>
      <p class="text-gray-600 leading-relaxed">
        We proudly use <span class="font-semibold text-green-800">Areca leaf boxes</span> 
        and biodegradable packaging for all deliveries. By avoiding plastics, we ensure that 
        your meals are not only tasty but also kind to our planet.
      </p>
    </div>
    <div class="flex justify-center">
      <img src="images/about/areca-box.webp" alt="Areca Eco Friendly Packaging" class="rounded-lg shadow-md max-h-[250px]">
    </div>
  </section>

  <!-- Special Meal Boxes -->
  <section class="max-w-5xl mx-auto py-10 px-5 text-center">
    <h3 class="text-2xl font-bold mb-3">🎁 Special Meal Boxes</h3>
    <p class="text-gray-600 leading-relaxed">
      Celebrate festivals, birthdays, and special occasions with our curated 
      <b>Special Meal Boxes</b>. Designed with love and packed sustainably.
    </p>
  </section>
  ...
  <section class="max-w-5xl mx-auto py-10 px-5 text-center">
    ...
    <p class="text-gray-700 text-lg leading-relaxed">
      To empower home chefs, promote sustainable living, and create a positive 
      food culture where every meal is delivered with care for both people and the planet.
    </p>
  </section>

  <!-- Footer -->
  <footer class="bg-gray-900 text-white py-6 text-center mt-10">
    <p>© <?php echo date("Y"); ?> Alimento. All Rights Reserved.</p>
  </footer>
